...
//get && select Data from fetch offers 
    import {
        getDataSharing,
        selectDataSharing
    }from '../pages/store/fetchdatasharing'
...
import {incrementSharing,decrementSharing} from '../pages/store/fetchdatasharing' 
...
function Forsharing (){
       ...
       //Get Data From Fetch Data Offers
        const {
            ...
            pending,
            error,
        } = useAppSelector(selectDataSharing)
            ...
            >
...

                {
                    data.map((post: any,id:number) => (
                        ...
                        <ButtonGroup color = 'error'  variant="contained" onClick={() => dipatchev(incrementSharing(id))}>
                            ...
                            <ButtonGroup color='error'  variant ="contained" onClick={() => dipatchev(decrementSharing(id))} >
