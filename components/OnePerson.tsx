...
//get && select Data from fetch offers 
    import {
        getDataOnePerson,
        selectDataOnePerson
    }from '../pages/store/fetchdataoneperson'
...
import {incrementOneperson,decrementOneperson} from '../pages/store/fetchdataoneperson' 
...
function OnePerson (){
       ...
       //Get Data From Fetch Data Offers
        const {
            ...
            pending,
            error,
        } = useAppSelector(selectDataOnePerson)
                    ...
                    data.map((post: any,id:number) => (
                        <Card sx={{ maxWidth: 345,height:'350px' }} key={id} >
                            ...
                            <CardMedia
                                ...
                                alt={post.label}
                            />
                              <Typography gutterBottom variant="h6" component="p" color='error' sx={{fontWeight:'700'}}>
                                    {post.label}
                            </Typography>
                            <CardActionArea>
                        ...
                        <ButtonGroup color = 'error'  variant="contained" onClick={() => dipatchev(incrementOneperson(id))}>
                            ...
                            <ButtonGroup color='error'  variant ="contained" onClick={() => dipatchev(decrementOneperson(id))} >
